                           ...
                           return(
                            ...
                            <div className="card-heading">
                                <div className="user-block">
                                    <div className="image">
                                        <img src={result.section_details[0].url} data-demo-src={result.section_details[0].url} alt="" />
                                    </div>
                            ...
                            <div className="card-footer">
                                <div className="likers-group">
                                    <div onClick={this.onLike} data-postid={result._id} data-liked={result.liked ? true: false}  data-count={this.like_count} className={result.liked ? "post-liked fab-wrapper post-action mr-6": "fab-wrapper post-action mr-6"}>
                                    ...
                                    <div className="fab-wrapper post-action mr-6" data-postid={result._id} onClick={(e)=>this.props.setPostId(e.currentTarget.dataset.postid)}>
                                ...
                                <div className="social-count">
                                    ...
                                    <div className="likes-count">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-thumbs-up"><path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3"></path></svg>
                                        <span id={`${result._id}_liked`}>{result.like_count}</span>
                                    </div>
