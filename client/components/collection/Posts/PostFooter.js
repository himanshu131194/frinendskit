        ...
        return(
                ...
                <div className="likers-group">
                    ...
                    <div className="fab-wrapper post-action mr-10" data-postid={this.props.onPost._id}>
                        <a href={`https://www.facebook.com/sharer/sharer.php?u=https://feelfunny.app/share-facebook?post_title=${this.props.onPost.title}&post_content=${this.props.onPost.url}`} className="small-fab modal-trigger share-fb">
